...
localparam [1:0] RUNNING_0 = 2'b01;
localparam [1:0] RUNNING_1 = 2'b10;
localparam [1:0] RUNNING_2 = 2'b11;
   ...
   // - Initialize registers.
	...
	for (i = 0; i < 8; i = i+1) begin
		...
		case (state_reg[i])
			...
			RUNNING_2: begin// give block scheduler time to read outputs
				state_reg[i] = WAITING;
			end // RUNNING_2
		endcase
	end
